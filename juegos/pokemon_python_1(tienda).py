...
#Suma de las superpociones e hiperpociones que tienes
print("Contra Azul necesitarás varios objetos de curación para curar a tus pokemons")
objeto_pokemon =input("Entraste a la tienda, bienvenido en que puedo ayudarle. Solo puedes comprar:\n hiperpociones (1), revivir (2) o antiparalizantes (3), que quieres: ")
if int(objeto_pokemon) == 1:
    cantidad_hiperpociones = input("¿Cuántas quieres?")
    print(f"Has comprado {cantidad_hiperpociones} hiperpociones")
elif int(objeto_pokemon) == 2:
    cantidad_revivir = input("¿Cuántos revivires quieres?")
    print(f"Has comprado {cantidad_revivir} revivires")
elif int(objeto_pokemon) == 3:
    cantidad_antiparalizantes = input("¿Cuántos antiparalizantes quieres?")
    print("Has comprado")